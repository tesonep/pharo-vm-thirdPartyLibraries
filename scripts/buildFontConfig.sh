...
downloadAndUntar https://freedesktop.org/software/fontconfig/release/fontconfig-$FONTCONFIG_VERSION.tar.xz fontconfig-$FONTCONFIG_VERSION.tar.gz fontconfig-$FONTCONFIG_VERSION
