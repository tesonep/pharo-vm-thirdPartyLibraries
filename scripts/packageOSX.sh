...
buildPackage harfbuzz $HARFBUZZ_VERSION "libharfbuzz.*dylib" "libharfbuzz-cairo*dylib"
...
buildPackage openssl $OPENSSL_VERSION "libssl*.dylib" "libcrypto*.dylib"
buildPackage libssh2 $LIBSSH2_VERSION "libssh2*.dylib"